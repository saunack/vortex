...
VL_INLINE_OPT void Vvortex_afu_shim_vortex_afu_shim___sequent__TOP__vortex_afu_shim__0(Vvortex_afu_shim_vortex_afu_shim* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vvortex_afu_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vvortex_afu_shim_vortex_afu_shim___sequent__TOP__vortex_afu_shim__0\n"); );
    // Body
...
VL_INLINE_OPT void Vvortex_afu_shim_vortex_afu_shim___combo__TOP__vortex_afu_shim__0(Vvortex_afu_shim_vortex_afu_shim* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vvortex_afu_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vvortex_afu_shim_vortex_afu_shim___combo__TOP__vortex_afu_shim__0\n"); );
    // Init
